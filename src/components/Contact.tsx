    ...
    <section className="py-20 flex flex-col items-center text-center">
      ...
      <div className="mb-16">
        ...
        <div className="flex gap-4">
          <a
            href="https://github.com/bruceowenga"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="w-10 h-10 bg-[#1a1a1a] rounded flex items-center justify-center text-secondary hover:text-white hover:bg-[#2a2a2a] transition border border-[#333]"
          >
          ...
          <a
            href="https://www.linkedin.com/in/brucembudi"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="w-10 h-10 bg-[#1a1a1a] rounded flex items-center justify-center text-secondary hover:text-white hover:bg-[#2a2a2a] transition border border-[#333]"
